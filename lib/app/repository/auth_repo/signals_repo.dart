...
import '../../mvvm/model/response_model/signals_response_model.dart';
...
class SignalsRepo {
  ...
  Future<ApiResponse<SignalsData>> fetchSignals() async {
    try {
      String? endPoint = ApiUrls.signals;
      final response = await HttpsCalls().getApiHits(endPoint);
      return _processResponse(response, (dataJson) => SignalsData.fromJson(dataJson));
    } catch (e, stackTrace) {
